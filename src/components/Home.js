        ...
        return (
            <div>
                ...
                <div className="txt-box">
                    ...
                    <div className="ply-week">
                        <h3>Player of the Week!</h3>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/MEWSjzw2jVw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
